...
//***************************************************
		...
		//alert("groceryItemValue " + groceryItemValue);

		// checking the correct radio button
		for(var i=0; i<groceryItemValue.length; i++){
			if(groceryItemValue[i].value =="Fruit" && obj.groceryItem[i] =="fruit"){
				groceryItem[i].setAttribute("checked","checked");
			}else if(groceryItemValue[i].value =="Veggie" && obj.groceryItem[i] =="veg"){
				groceryItem[i].setAttribute("checked","checked");
			}else if(groceryItemValue[i].value =="Dairy" && obj.groceryItem[i] =="dairy"){
				groceryItem[i].setAttribute("checked","checked");
			}else if(groceryItemValue[i].value =="Meat" && obj.groceryItem[i] =="meat"){
				groceryItem[i].setAttribute("checked","checked");
			}else if(groceryItemValue[i].value =="Snack" && obj.groceryItem[i] =="snack"){
				groceryItem[i].setAttribute("checked","checked");
			}
